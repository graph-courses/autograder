...
```{r, echo=FALSE, eval=TRUE,fig.cap="Use the check snippet. GIF captured with LICEcap.",fig.align='center'}
...
- First, go to _Tools -> Global Options -> Code -> Snippets -> Edit Snippets_, 
